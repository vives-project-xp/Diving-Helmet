...
<p>
    ...
    <h1>Photos &#x1F4F7;</h1>
        ...
        <br>
        <br>
        <img src="./foto4.png" alt="" height= "400"  style= "border:10px solid #D3D3D3; padding:1px; margin:7px"><br>
        <br>
        <br>
        <br>
        <br>
        <img src="./foto5.png" alt="" height= "400"  style= "border:10px solid #D3D3D3; padding:1px; margin:7px"><br>
        <br>
        <br>
        <br>
        <br>
